...
/**
 ...
 line 3 free
 */
class FC1neu_hardware: public hardware
{
 ...
 */
class FC1neu_core: public core
{
    std::string the_name;
public:
    FC1neu_core(const core_config& conf) :
        core(conf),
        the_name("FC1neu core")
    {
        the_hardware = new FC1neu_hardware();
    }
